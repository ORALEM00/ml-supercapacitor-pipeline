...
""" def train_test_tunning(df, model_class, space_search, feature_selection = False, mu = 0, random_state = 42, params = None,
                       n_trials = 50, target = 'Specific_Capacitance', group_id_column = 'Electrode_ID'):
    # Shuffle df
    ...
    study_model = run_study(innerTrain, model_class, inner_cv_splitter, space_search, mu, 
...
""" def nested_cv_tunning(df, model_class, outer_cv_splitter, inner_cv_splitter, space_search, 
