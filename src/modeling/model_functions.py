...
""" def train_test_analysis(df, model_class, feature_selection = False, params = None, weights = None,
...
""" def cv_analysis(df, model_class, cv_splitter, feature_selection = False, params = None, weights = None,
                random_state = 42, target_column = 'Specific_Capacitance', 
                group_id_column = 'Electrode_ID'):
    # Copy df
    X = df.copy()
